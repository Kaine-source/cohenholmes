---
title: "I rebuilt my website with AI agents in six days. Here's what that actually looked like."
description: "A first-person account of rebuilding cohenholmes.co.uk with Claude Code and GitHub Copilot — what got built, what went wrong, and why running two orchestrating agents on one repo was a mistake."
pubDate: 2026-09-06
tags: ["ai", "workflow"]
draft: false
---
...
- A writing page that pulled my Medium posts through a small server-side function, so the feed's
  missing CORS headers stopped being my problem. (That page has since been replaced by the native
  blog you're reading this on.)
...
main.](/blog/diagrams/blog2-pipeline.png)
